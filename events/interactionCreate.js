...
module.exports = async (client, interaction) => {
    ...
    if (interaction.isSelectMenu() && interaction.customId.startsWith("filters:")) {
        return FilterSelector(client, interaction);
    }

    if (interaction.isButton() && (interaction.customId.startsWith("queue:") || interaction.customId.startsWith("volume:"))) {
